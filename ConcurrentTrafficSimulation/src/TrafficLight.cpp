...
void TrafficLight::cycleThroughPhases()
{
    ...
    // Generate a random number between 4000 and 6000 (https://en.cppreference.com/w/cpp/numeric/random/uniform_int_distribution)
    ...
    while (true)
    {
        ...
        if (timeSinceLastUpdate >= static_cast<long>(cycleDuration))
        {
